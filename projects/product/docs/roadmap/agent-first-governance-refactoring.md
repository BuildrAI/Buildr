...
随包 [内联核心规则](../../services/buildr/resources/workspace/AGENTS.md) 是最高层产品哲学与通用边界。[当前产品架构](../../knowledge/docs/architecture/product.md) 已经明确：Buildr 采用宽而薄的治理，不成为另一个智能体（Agent），不把推荐流程变成唯一合法路径。
