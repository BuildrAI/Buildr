...
export function registerLegacyRuntime(runtime, { installAgentAssetsModule, installTaskRecordModule, installTaskReviewModule, installTaskRetrospectiveModule, installWorkspaceModule }) {
