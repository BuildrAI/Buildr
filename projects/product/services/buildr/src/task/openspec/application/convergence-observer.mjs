...
import { convergenceDigest, normalizeConvergenceText, validateConvergenceReceipt } from './convergence-model.mjs';

export function observeConvergence({ projectRoot, receipt, archived = false, io }) {
