...
function parseTaskRecordCli(action, args) {
  const usages = {
    ...
    update: 'buildr task update <task-id> [--status todo|active|completed|abandoned] [--reason <text>] [--summary <text>] [--no-change] [--parent-completion <json-file>] [--expected-record <recordDigest>] [--title <text>] [--intent <text>] [--parent <task-id> | --clear-parent] [--add-retrospective-source <task-id> ...] [--remove-retrospective-source <task-id> ...] [--add-project <code> ...] [--remove-project <code> ...] [--add-service <project/service> ...] [--remove-service <project/service> ...] [--add-change <project/change> ...] [--remove-change <project/change> ...] [--target <canonical-workspace>] [--json]',
  ...
  const allowedByAction = {
    ...
    update: new Set(['--status', '--reason', '--summary', '--no-change', '--parent-completion', '--title', '--intent', '--parent', '--clear-parent', '--parent-task', '--expected-record', '--add-retrospective-source', '--remove-retrospective-source', '--add-project', '--remove-project', '--add-service', '--remove-service', '--add-change', '--remove-change', '--target', '--json']),
