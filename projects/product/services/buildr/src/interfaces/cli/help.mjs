...
export function registerCommandHelp(runtime) {
  ...
  function usage() {
    ...
    console.error('  buildr task finish <inspect|advance|resume|renew|run|recover|cleanup-prepare|cleanup-finalize> --run <id> [--task <id> --change <id> --target-branch <branch>] [--fingerprint <step>=<value> ...] [--execution-plan <json> | --execution-plans <json>] [--recovery <json>] [--repair-authorization <json>] [--ref-transition <json>] [--detail <compact|full>] [--json]');
