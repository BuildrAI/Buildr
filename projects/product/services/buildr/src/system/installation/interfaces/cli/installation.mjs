  ...
  return Object.freeze([
    {
      ...
      run: (runtime, context) => runtime.installationStatus(context.argv.slice(4)),
    },
    {
      key: 'update check',
      surface: 'primary',
      ...
      run: (runtime, context) => runtime.updateCheck(context.argv.slice(4)),
    },
    {
      key: 'update',
      surface: 'primary',
      ...
      run: (runtime, context) => runtime.updateBuildr(context.argv.slice(3)),
    },
  ].map(Object.freeze));
}
