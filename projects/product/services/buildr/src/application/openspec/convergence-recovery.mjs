...
function blocked(status, code, message, evidence = {}) {
...
export function createConvergenceRecoveryReceipt(plan, stage = 'planned', transitions = []) {
...
export function continueConvergenceRecoveryReceipt(plan, existing = null) {
