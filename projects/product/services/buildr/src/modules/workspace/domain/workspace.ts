...
export type WorkspaceInput = { id: string; name: string; description: string };
export type Workspace = Readonly<WorkspaceInput>;
...
export function createWorkspace({ id, name, description }: WorkspaceInput): Workspace {
