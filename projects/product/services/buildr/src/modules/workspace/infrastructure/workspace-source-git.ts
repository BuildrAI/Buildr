...
import { isGitUrl } from '../../../infrastructure/git/identity.ts';
...
export function readGitRemote(repoPath: string, remoteName: string) {
  try { return gitOutput(['remote', 'get-url', remoteName], repoPath); }
  catch { return null; }
}

export function gitignoreLines(targetRoot: string) {
...
export function registerWorkspaceSourceGit(runtime: WorkspaceSourceGitRuntime) {
  return Object.assign(runtime, {
    gitOutput, readGitRemote, gitignoreLines,
...
export { isGitUrl } from '../../../infrastructure/git/identity.ts';
