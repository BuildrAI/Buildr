  ...
  return Object.freeze({
    ...
    create(requires: { [WORKSPACE_ASSET_SUPPORT]: WorkspaceAssetSupport; [AGENT_ASSETS_RUNTIME]: ReturnType<typeof runtimeCompositionPort> }): any {
      ...
      const application = Object.freeze({
        ...
        skillRegistrationCandidates: skills.skillRegistrationCandidates,
        registerLocalSkill: skills.registerLocalSkill,
        skillRemoval: skills.skillRemoval,
        removeRegisteredSkill: skills.removeRegisteredSkill,
