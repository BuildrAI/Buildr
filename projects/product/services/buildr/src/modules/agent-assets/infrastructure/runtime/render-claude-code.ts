...
export function renderClaudeCode(argv: any, options: any = {}): any  {
  ...
  const command = options.command ?? 'node src/modules/agent-assets/infrastructure/runtime/render-claude-code.mjs';
...
export function installClaudeCodeBuildrSkill(argv: any, options: any = {}): any  {
  const repoRoot = options.repoRoot ?? process.cwd();
  const command = options.command ?? 'node src/modules/agent-assets/infrastructure/runtime/render-claude-code.mjs install';
