CREATE TABLE terminal_contribution_reconciliations (
  ...
  record_json TEXT NOT NULL CHECK (
    ...
    AND json_extract(record_json, '$.schemaVersion') = 'buildr.terminal-contribution-reconciliation/v1'
...
CREATE INDEX terminal_contribution_reconciliations_parent_idx
  ON terminal_contribution_reconciliations(parent_task_id, child_task_id);
