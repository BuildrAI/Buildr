...
import { ensureFile } from './primitives.ts';
...
export function capabilityKey(capability: any, version: any): any  {
  return `${capability}@${version}`;
}

export function validateCapabilityIdentity(capability: any, version: any, label: any): any  {
