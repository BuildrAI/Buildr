...
export function retireLegacyCoreRule({ targetRoot, rulesManifest, receiptByKey, builtinSnapshot, removeReceipt, changed, findings, checkOnly }) {
  const id = 'buildr-core';
  const target = 'rules/buildr/core.md';
  const index = rulesManifest.rules.findIndex((rule) => rule.id === id);
