...
async function main(args = process.argv.slice(2)) {
  ...
  const identity = {
    schemaVersion: 'buildr.launcher-identity/v1', version: packageData.version, channel: 'development', source: 'checkout',
