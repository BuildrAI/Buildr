...
const allowed: any = new Map([
  ...
  ['src/workspace/application/project-creation-application.ts', new Set(['createProjectAsset'])],
  ['src/workspace/application/service-creation-application.ts', new Set(['createServiceAsset'])],
