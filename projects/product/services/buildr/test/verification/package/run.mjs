...
function usage(stream = process.stdout) {
  stream.write('Usage: node test/verification/package/run.mjs <selector>\n\n');
...
if (!selector || selector === '--help' || selector === '-h') {
  ...
  try {
    ...
    const result = spawnSync(process.execPath, [path.join(productRoot, 'bin', 'buildr.mjs'), 'package', 'check'], {
      cwd: productRoot,
