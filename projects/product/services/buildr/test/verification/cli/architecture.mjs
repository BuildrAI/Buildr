...
if (fs.existsSync(registry)) {
  ...
  const expectedKeys = [
    'init', 'app launcher install', 'app launcher status', 'app launcher uninstall', 'app preview start', 'app preview list', 'app preview stop', 'app', 'bootstrap guide', 'package check', 'package build', 'project create', 'service create', 'worktree create', 'worktree cleanup', 'worktree inspect', 'worktree context', 'worktree adopt', 'verification run', 'verification cleanup', 'task finish actions', 'task finish inspect', 'task finish advance', 'task finish resume', 'task finish renew', 'task finish run', 'task finish recover', 'task finish cleanup-prepare', 'task finish cleanup-finalize',
