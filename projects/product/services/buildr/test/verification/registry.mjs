...
export const verificationSteps = Object.freeze([
  ...
  step({ id: 'contract', name: 'repository contract tests', executor: { type: 'npm', args: ['run', 'test:contract'] }, profiles: ['fast', 'candidate'], inputs: [
    ...
    'scripts/verify-buildr-product', 'scripts/verify-buildr-product-fast', 'scripts/verify-buildr-product-ci', 'scripts/resolve-development-node', 'scripts/run-development-node', 'scripts/run-development-npm',
