...
const SYSTEM_OWNER_INPUTS = Object.freeze({
  ...
  'system-task-lifecycle': Object.freeze(['src/task/**', 'src/application/task-development/**', 'src/application/task-review/**', 'src/application/task-verification/**', 'src/application/change/**', 'src/domain/task-development/**', 'src/domain/task-review/**', 'src/domain/task-verification/**', 'src/infrastructure/sqlite/task-development-repository.mjs', 'src/infrastructure/sqlite/task-review-repository.mjs', 'src/infrastructure/sqlite/task-verification-repository.mjs', 'test/helpers/task-record-system-fixture.mjs']),
...
export const verificationSteps = Object.freeze([
  ...
  step({ id: 'cli-architecture', name: 'CLI modular architecture', executor: { type: 'node', file: 'test/verification/cli/architecture.mjs' }, profiles: ['fast', 'candidate'], inputs: ['bin/**', 'src/interfaces/cli/**', 'src/task/**', 'src/application/compose-runtime.mjs', 'src/application/json-contracts.mjs', 'scripts/**', 'test/verification/cli/**', 'package.json'] }),
