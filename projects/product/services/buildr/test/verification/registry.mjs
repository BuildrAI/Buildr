...
const SYSTEM_OWNER_INPUTS = Object.freeze({
  ...
  'system-task-lifecycle': Object.freeze([
    ...
    'src/task/domain/task-planning-identity.mjs', 'src/task/domain/parent-coordination.mjs', 'src/task/domain/terminal-contribution-reconciliation.mjs',
    ...
    'src/task/persistence/task-*.mjs', 'src/task/persistence/parent-coordination-repository.mjs', 'src/task/persistence/terminal-contribution-reconciliation-repository.mjs',
  ...
  'system-buildr-web-http': Object.freeze(['src/bootstrap/**', 'src/workspace/module.mjs', 'src/workspace/interfaces/http/**', 'src/task/module.mjs', 'src/task/change/interfaces/http/**', 'src/task/interfaces/http/**', 'src/system/publication/interfaces/http/**', 'src/web/http/**', 'src/infrastructure/sqlite/**', 'services/buildr-web/src/api/**', 'test/helpers/workspace-product-suite.mjs']),
  'system-app-process': Object.freeze(['src/web/**', 'src/infrastructure/process.mjs', 'package/launchers/**', 'tools/development/run-isolated-workspace-smoke.mjs', 'tools/development/workspace-smoke.mjs', 'test/fixtures/failing-workspace-smoke.mjs', 'test/helpers/workspace-product-suite.mjs']),
...
export const verificationSteps = Object.freeze([
  ...
  step({ id: 'integration-candidate-release', name: 'Candidate integration: release contract and Git convergence', executor: { type: 'npm', args: ['run', 'test:integration:candidate:release'] }, groups: ['release'], inputs: [
    'test/integration-candidate-release/**', 'tools/release/release-git-convergence.mjs', 'tools/release/release-authority.mjs', 'tools/release/release-contract.mjs', 'tools/release/release-task-evidence-correlation.mjs', 'tools/release/release-transaction-evidence.mjs', 'tools/release/release-transaction-runner.mjs',
