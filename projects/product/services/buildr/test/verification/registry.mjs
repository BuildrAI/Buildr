...
export const verificationSteps = Object.freeze([
  ...
  step({ id: 'cli-architecture', name: 'CLI modular architecture', executor: { type: 'node', file: 'test/verification/cli/architecture.mjs' }, profiles: ['fast', 'candidate'], inputs: ['bin/**', 'src/bootstrap/**', 'src/interfaces/cli/**', 'src/interfaces/local-app/http/server.mjs', 'src/task/**', 'src/application/json-contracts.mjs', 'resources/**', 'web-dist/**', 'tools/**', 'package/**', 'test/verification/cli/**', 'package.json'] }),
