...
const SYSTEM_OWNER_INPUTS = Object.freeze({
  ...
  'system-task-finish-cli': Object.freeze(['src/bootstrap/cli/**', 'src/application/task-finish/task-finish-result-projection.mjs', 'src/application/task-finish/task-finish-self-bootstrap-projection.mjs', 'src/application/json-contracts.mjs', 'src/interfaces/cli/**', 'test/helpers/task-finish-sqlite-fixture.mjs']),
...
export const INTEGRATION_PRIMARY_SLICES = Object.freeze([
  ...
  integrationSlice('integration-task-finish', [
    ...
    'src/application/task-finish/task-finish-maintenance.mjs',
  ...
  integrationSlice('integration-task-finish-delivery', [
    ...
    'src/application/task-finish/task-finish-occupancy-release.mjs',
    'src/application/task-finish/task-finish-delivery-commit.mjs',
    'src/application/task-finish/task-finish-delivery-reconciliation.mjs',
