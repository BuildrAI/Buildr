...
export const VERIFICATION_STEP_TESTING = Object.freeze({
  ...
  'repository-onboarding': testing(PROJECT_OWNER, 'Delivery / Release', 'System', 25000, 'A clean repository can use the explicit development entry without mutating the PATH default CLI.', TEST_ENVIRONMENTS.workspaceLifecycle),
