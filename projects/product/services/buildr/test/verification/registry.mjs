...
const SYSTEM_OWNER_INPUTS = Object.freeze({
  ...
  'system-worktree-lifecycle': Object.freeze(['src/application/worktree/**', 'src/task/application/task-environment-application.mjs', 'src/task/domain/project-environment-preparation.mjs', 'src/task/domain/task-environment*.mjs', 'src/infrastructure/git/**', 'test/helpers/workspace-product-suite.mjs']),
...
export const verificationSteps = Object.freeze([
  ...
  step({ id: 'contract', name: 'repository contract tests', executor: { type: 'npm', args: ['run', 'test:contract'] }, profiles: ['fast', 'candidate'], inputs: [
    ...
    'src/bootstrap/module-registry.mjs', 'src/bootstrap/runtime.mjs', 'src/bootstrap/legacy-runtime-module.mjs',
    'src/bootstrap/cli/registry.mjs', 'src/task/module.mjs', 'src/interfaces/local-app/http/server.mjs',
  ...
  step({ id: 'cli-architecture', name: 'CLI modular architecture', executor: { type: 'node', file: 'test/verification/cli/architecture.mjs' }, profiles: ['fast', 'candidate'], inputs: ['bin/**', 'src/bootstrap/**', 'src/interfaces/cli/**', 'src/interfaces/local-app/http/server.mjs', 'src/web/**', 'src/task/**', 'src/application/json-contracts.mjs', 'resources/**', 'web-dist/**', 'tools/**', 'package/**', 'test/verification/cli/**', 'package.json'] }),
  ...
  step({ id: 'runtime-adapter-contract', name: 'runtime adapter contract', executor: { type: 'node', file: 'test/verification/runtime/adapter-contract.mjs' }, profiles: ['candidate'], groups: ['runtime'], inputs: ['src/agent-assets/infrastructure/runtime/**', 'src/agent-assets/application/runtime.mjs', 'src/application/doctor/runtime-diagnostics.mjs', 'test/verification/runtime/adapter-contract.mjs', 'package/targets/runtime/**', 'docs/agent-runtime-adapters.md'] }),
  ...
  step({ id: 'concurrent-task-acceptance', name: 'Concurrent task workflow acceptance', executor: { type: 'node', file: 'test/verification/concurrency/task-acceptance.mjs' }, profiles: ['candidate'], groups: ['windows-npm-preflight'], inputs: [
    ...
    'src/application/worktree/**', 'src/task/application/task-verification-application.mjs', 'src/application/verification/**', 'src/web/application/preview-lifecycle.mjs',
  ...
  step({ id: 'host-node-cli-smoke', name: 'Host Node installed CLI smoke', executor: { type: 'node', file: 'test/verification/host-node/cli-smoke.mjs', consumesArtifact: true }, profiles: ['host-node'], inputs: [
    'buildr', 'bin/buildr.mjs', 'src/bootstrap/**', 'src/interfaces/cli/**', 'src/application/doctor/**',
  ...
  step({ id: 'commands-cli-integration', name: 'Commands context CLI integration', executor: { type: 'node', file: 'test/commands-cli.integration.mjs' }, profiles: ['candidate'], groups: ['cli', 'package'], inputs: ['commands.yml', 'test/commands-cli.integration.mjs', 'src/agent-assets/application/commands.mjs', 'src/agent-assets/application/components.mjs', 'src/agent-assets/application/skills.mjs', 'src/workspace/**', 'src/application/doctor/**', 'src/bootstrap/cli/help.mjs', 'resources/manifest.yml'], schedulingCostMs: 12000, concurrencyClass: 'workspace-heavy' }),
  step({ id: 'openspec-contract-fixtures', name: 'OpenSpec contract fixtures', executor: { type: 'node', file: 'test/verification/openspec/contract.mjs', args: ['--suite', 'contract'] }, profiles: ['candidate'], groups: ['openspec'], inputs: ['src/application/domains/openspec.mjs', 'src/application/openspec/**', 'test/verification/openspec/contract.mjs', 'resources/workspace/skills/buildr/openspec-contract-guard/**'], concurrencyClass: 'cpu-heavy' }),
  step({ id: 'openspec-convergence-recovery', name: 'OpenSpec convergence recovery journey', executor: { type: 'node', file: 'test/verification/openspec/contract.mjs', args: ['--suite', 'recovery'] }, profiles: ['candidate'], groups: ['openspec', 'recovery'], inputs: ['src/application/domains/openspec.mjs', 'src/application/openspec/**', 'test/verification/openspec/contract.mjs', 'resources/workspace/skills/buildr/openspec-contract-guard/**', 'resources/workspace/skills/buildr/task-development/**', 'resources/workspace/skills/buildr/current-knowledge-maintenance/**'], schedulingCostMs: 40000, concurrencyClass: 'workspace-heavy', resources: ['workspace-saturating'] }),
  ...
  step({ id: 'runtime-adapter-parity', name: 'runtime adapter implementation-family parity', executor: { type: 'node', file: 'test/verification/runtime/adapter-parity.mjs' }, profiles: ['candidate'], groups: ['runtime', 'windows-npm-preflight'], inputs: ['src/agent-assets/infrastructure/runtime/**', 'src/agent-assets/application/runtime.mjs', 'src/application/doctor/runtime-diagnostics.mjs', 'test/verification/runtime/adapter-parity.mjs', 'test/verification/runtime/fixture.mjs', 'package/targets/runtime/**', 'resources/workspace/rules/**'], schedulingCostMs: 35000, concurrencyClass: 'workspace-heavy', resources: ['workspace-saturating'] }),
  ...
  step({ id: 'managed-data-integrity', name: 'managed data integrity', executor: { type: 'node', file: 'test/verification/integrity/managed-data-integrity.mjs' }, profiles: ['candidate'], groups: ['package'], inputs: [
    ...
    'src/workspace/**', 'src/application/doctor/**',
