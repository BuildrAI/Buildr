...
export const verificationSteps = Object.freeze([
  ...
  step({ id: 'integration-candidate-release', name: 'Candidate integration: release contract and Git convergence', executor: { type: 'npm', args: ['run', 'test:integration:candidate:release'] }, groups: ['release'], inputs: [
    'test/integration-candidate-release/**', 'tools/release/bridge-main-to-dev.mjs', 'tools/release/release-authority.mjs', 'tools/release/release-contract.mjs', 'tools/release/release-task-evidence-correlation.mjs', 'tools/release/release-transaction-evidence.mjs', 'tools/release/release-transaction-runner.mjs',
