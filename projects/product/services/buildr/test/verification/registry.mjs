...
export const VERIFICATION_FULL_SCOPE_INPUTS = Object.freeze([
  ...
  'scripts/resolve-development-node',
  'scripts/run-development-node',
  'scripts/run-development-npm',
  'scripts/run-development-npm.mjs',
...
export const verificationSteps = Object.freeze([
  ...
  step({ id: 'contract', name: 'repository contract tests', executor: { type: 'npm', args: ['run', 'test:contract'] }, profiles: ['fast', 'candidate'], inputs: [
    ...
    'scripts/release/release-transaction-runner.mjs',
    'scripts/release/release-tag-ensure.mjs',
    ...
    'scripts/verify-buildr-product', 'scripts/verify-buildr-product-fast', 'scripts/verify-buildr-product-ci', 'scripts/resolve-development-node', 'scripts/run-development-node', 'scripts/run-development-npm', 'scripts/run-development-npm.mjs',
  ...
  step({ id: 'cli-architecture', name: 'CLI modular architecture', executor: { type: 'node', file: 'test/verification/cli/architecture.mjs' }, profiles: ['fast', 'candidate'], inputs: ['bin/**', 'src/bootstrap/**', 'src/interfaces/cli/**', 'src/interfaces/local-app/http/server.mjs', 'src/task/**', 'src/application/json-contracts.mjs', 'scripts/**', 'test/verification/cli/**', 'package.json'] }),
  ...
  step({ id: 'package-workspace', ...packageVerifier('workspace'), profiles: ['candidate'], groups: ['package'], inputs: ['package/manifest.yml', 'package/targets/workspace/AGENTS.md', 'package/targets/workspace/components/**', 'src/application/domains/workspace.mjs', 'src/application/workspace-operations.mjs', 'src/application/package-maintenance/**'], schedulingCostMs: 7000, concurrencyClass: 'workspace-heavy' }),
  ...
  step({ id: 'init-onboarding', name: 'single-command init onboarding', executor: { type: 'node', file: 'test/verification/onboarding/init.mjs' }, profiles: ['candidate'], inputs: ['src/application/domains/workspace.mjs', 'src/application/workspace-operations.mjs', 'test/verification/onboarding/init.mjs', 'package/targets/workspace/manifest.yml', 'package/targets/workspace/AGENTS.md', 'package/targets/workspace/components/**'], schedulingCostMs: 7000, concurrencyClass: 'workspace-heavy' }),
  ...
  step({ id: 'remote-skill-timeout', name: 'remote Skill timeout contract', executor: { type: 'node', file: 'test/verification/network/remote-text.mjs' }, profiles: ['candidate'], inputs: [
    ...
    'src/bootstrap/cli/main.mjs', 'scripts/release/application-payload-entry.mjs',
