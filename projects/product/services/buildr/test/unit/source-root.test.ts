...
import { createProjectSource } from '../../src/modules/workspace/domain/project.ts';
import { createServiceSource } from '../../src/modules/workspace/domain/service.ts';
import { resolveSourceRoot } from '../../src/modules/workspace/infrastructure/workspace-source-filesystem.ts';
import { sourceIdentity, sourceOwnership, sourceRootKind } from '../../src/modules/workspace/domain/source-root.ts';
