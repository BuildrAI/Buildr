...
import { createWorkspace, isWorkspaceId } from '../../src/modules/workspace/domain/workspace.ts';
import { resolveWorkspaceIdentity } from '../../src/modules/workspace/application/workspace-query-application.ts';

const WORKSPACE_ID: any = 'f2f40b71-2382-5906-82bd-76a7927b59f3';

test('Workspace Domain 只使用稳定 UUID 与通用 metadata', () => {
  const workspace: any = createWorkspace({ id: WORKSPACE_ID, name: ' Buildr ', description: ' Product workspace ' });
...
test('Workspace identity 复用已有 UUID、按需生成并拒绝冲突', () => {
  const generated: any = '6c2d67c4-399f-4b54-9171-8ea3512ef394';
