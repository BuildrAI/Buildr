...
test('Buildr self-bootstrap is a Workspace Component contribution, not a package capability', () => {
  ...
  for (const phrase of ['buildr.self-bootstrap-closeout-result/v1', 'buildr.self-bootstrap-recovery-plan/v1', 'foreign-carriers-require-owner-recovery', 'isolated-coexisting', 'stale-empty-container', 'unprovable', 'task-finish-target-lease-driver.mjs', 'target-lease-held', 'resume-owner-release-occupancy', '--release-occupancy', 'Buildr-Finish-Run', 'Buildr-Closeout-Plan', "'sync'", "'commit'", "'push'", "'install-buildr-web'", "'verify-development-entry'", "'finalize'", 'development-entry-launcher-mismatch', 'development-entry-cli-mismatch', 'development-entry-version-mismatch']) assert.ok(runner.includes(phrase), phrase);
