...
test('canonical Skill 模型同时表达 source、Project context 与 destinations', () => {
  const managed = fs.readFileSync(path.join(projectRoot, 'openspec/specs/managed-skill-assets/spec.md'), 'utf8');
  const project = fs.readFileSync(path.join(projectRoot, 'openspec/specs/project-registry/spec.md'), 'utf8');
