...
test('candidate full plan only uses Candidate profile and rejects changed-path options', () => {
  ...
  for (const id of ['system-verification-admission', 'system-verification-contracts', 'system-workspace-lifecycle', 'system-runtime-recovery', 'system-local-app-http', 'system-app-process', 'system-task-finish', 'system-fresh-build', 'docs-quality']) {
