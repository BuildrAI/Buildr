...
export function TaskWorkPath({ record, context, selected, onSelect }: {
  record: TaskRecord; context?: TaskWorkContext | null; selected: TaskNodeStage; onSelect(stage: TaskNodeStage): void;
}) {
