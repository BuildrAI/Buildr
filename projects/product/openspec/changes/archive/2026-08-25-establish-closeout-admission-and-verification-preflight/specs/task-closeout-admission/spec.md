...
定义 Candidate/Finish 重型路径开始前的只读收尾准入投影，用于在长时间执行启动前对账 Task、OpenSpec、Owner、Environment、目标身份、Execution Record 与资源等待。该投影提供跨 owner 的事实对账，不拥有任何专业状态或写入 authority。
